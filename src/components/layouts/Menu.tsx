...
function Menu(props: any) {
  ...
  return (
    <>
     {/* <ul className="top-hdr-links lg:hidden">
              {props.c_matalanMenu.c_top_header_links&&props.c_matalanMenu.c_top_header_links.map((toplinks:any)=>{console.log(toplinks)
                return   (
